...
decisiontree_classifier = rpart(formula = High_Worth ~ .,
                                data = training_set)

#predict the test set
y_pred = predict(decisiontree_classifier,
                 newdata = test_set[,-28],
                 type = 'class')
